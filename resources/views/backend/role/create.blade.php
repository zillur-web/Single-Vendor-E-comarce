                        ...
                        <form action="{{ route('role.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="role_name" class="form-control @error('role_name') is-invalid @enderror" id="role_name" placeholder="Enter Role Name" value="{{ old('role_name') }}" required>
                                    @error('role_name')
                                        ...
                                        @foreach ($permissions as $permission)
                                            <div class="col-md-3">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" name="permission[]" id="customCheckbox{{ $permission->id }}" value="{{ $permission->id }}">
